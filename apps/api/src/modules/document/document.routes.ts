...
import { deleteDocumentSchema, getDocumentSchema, uploadDocumentSchema } from "./document.schema";
...
router.get('/:id', validate(getDocumentSchema), controllers.getDocumentController);
router.delete('/:id', validate(deleteDocumentSchema), controllers.deleteDocumentController)
